...
# TODO
#  Warning: `Pkg.dir(pkgname, paths...)` is deprecated; instead, do `import Colonies; joinpath(dirname(pathof(Colonies)), "..", paths.
#  But, pathof just say LoadError: UndefVarError: Colonies not defined
crypto_lib_path = Pkg.dir("Colonies") * "lib/libcryptolib.so"
